      ...
      <div className="animate-slide-up space-y-7">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. BETA3FREE" value={promoCode}
              onChange={e => setPromoCode(e.target.value.toUpperCase())} className="pp-input"
              style={{ fontFamily: promoCode ? 'monospace' : undefined, textTransform: 'uppercase' }} />
          </div>
          <button type="submit" disabled={loading} className="pp-btn-primary w-full" style={{ paddingTop: '12px', paddingBottom: '12px' }}>
