      ...
      <div className="bg-gray-800 border border-gray-700 rounded-2xl max-w-lg w-full shadow-2xl">
        ...
        <div className="p-6">
          <div className="bg-gray-700 rounded-xl p-4 mb-6">
            <p className="text-gray-200 text-sm leading-relaxed">Upload a photo of a suspected parasite. Our AI will analyse it and provide identification, treatment information, and myth-busting insights — <span className="text-blue-400 font-medium">for just 1 credit per image</span>.</p>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div><div className="flex items-center gap-2"><Upload size={16} className="text-blue-400" /><span className="text-white font-medium text-sm">Upload your image</span></div><p className="text-gray-400 text-xs mt-1">Take a photo or upload from your gallery. Stool, blood, or skin samples accepted.</p></div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div><div className="flex items-center gap-2"><Microscope size={16} className="text-blue-400" /><span className="text-white font-medium text-sm">AI analyses in seconds</span></div><p className="text-gray-400 text-xs mt-1">Our AI detects parasite species, life stage, and urgency level with confidence scoring.</p></div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div><div className="flex items-center gap-2"><CreditCard size={16} className="text-blue-400" /><span className="text-white font-medium text-sm">1 credit per analysis</span></div><p className="text-gray-400 text-xs mt-1">Each image analysis costs 1 credit (~AUD $7.50). Much more affordable than a GP visit.</p></div>
            </div>
          </div>
