...
const AnnotatedImage = ({ imageUrl, detectionCount = 1 }) => {
  ...
  return (
    <div className="relative w-full rounded-lg overflow-hidden" style={{ background: '#0d0d1a', aspectRatio: '4/3' }}>
      {imageUrl && <CldImage src={imageUrl} alt="Specimen" width={800} mode="limit" priority={true} sizes="(max-width: 768px) 100vw, 800px" className="w-full h-full object-contain" />}
