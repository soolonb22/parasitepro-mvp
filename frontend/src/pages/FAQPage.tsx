...
const FAQ_ITEMS: FAQItem[] = [
  ...
  { category: 'Pricing', question: 'Can I get a refund?', answer: 'Credits are non-refundable once used. If you have unused credits and are unhappy with the service, please contact us at support@parasitepro.com within 14 days of purchase and we will review your case under Australian Consumer Law.' },
  ...
  { category: 'Technical', question: "I'm having trouble uploading. What should I try?", answer: 'Try these steps: (1) Ensure your image is JPEG or PNG under 10MB. (2) Check your internet connection. (3) Try a different browser. (4) Clear your browser cache. If the problem persists, contact support@parasitepro.com with a description of the issue.' },
];
