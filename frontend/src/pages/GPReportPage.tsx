    ...
    <div style={{ background:'#2E4A52', minHeight:'100vh', fontFamily:'"DM Sans","Inter",system-ui,sans-serif' }}>
      ...
      <div className="no-print" style={{ background:'rgba(0,0,0,0.25)', padding:'0.75rem 1.5rem', display:'flex', alignItems:'center', justifyContent:'space-between', gap:12 }}>
        ...
        <div style={{ display:'flex', gap:10 }}>
          <button onClick={handlePrint} style={{ display:'flex', alignItems:'center', gap:7, background:'rgba(255,255,255,0.12)', border:'1px solid rgba(255,255,255,0.25)', color:'white', padding:'8px 18px', borderRadius:8, cursor:'pointer', fontSize:'0.85rem', fontWeight:600 }}>
            <ExternalLink size={14} /> Save PDF for your GP
          </button>
      ...
      {/* Share PDF with GP modal — replaces former "My Health Record" modal */}
      {showMHR && (
        <div
          ...
          <div style={{ background:'#1A2A2E', border:'1px solid rgba(255,255,255,0.12)', borderRadius:20, width:'100%', maxWidth:480, padding:'2rem', position:'relative', boxShadow:'0 24px 64px rgba(0,0,0,0.5)' }}>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:'1.25rem' }}>
              <div style={{ width:44, height:44, borderRadius:12, background:'rgba(27,107,95,0.2)', border:'1px solid rgba(27,107,95,0.4)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                <Download size={20} style={{ color:'#5AB89A' }} />
              </div>
              <div>
                <h3 style={{ color:'white', fontWeight:800, fontSize:'1.05rem', margin:0 }}>Save PDF for your GP</h3>
                <p style={{ color:'rgba(255,255,255,0.5)', fontSize:'0.75rem', margin:0 }}>Download and bring to your next appointment</p>
              </div>
            </div>
            <div style={{ display:'flex', flexDirection:'column', gap:10, marginBottom:'1.5rem' }}>
              {[
                { n:'1', title:'Download your PDF report', desc:'Click "Download / Print PDF" below. Your report will save to your device as a PDF file.' },
                { n:'2', title:'Bring it to your GP appointment', desc:'Show the downloaded PDF to your doctor, or email it to your GP clinic ahead of your visit.' },
                { n:'3', title:'Let your GP make the call', desc:'Your doctor can use the educational report as a reference point for their clinical assessment.' },
              ].map(step => (
            ...
            <button onClick={() => { setShowMHR(false); handlePrint(); }} style={{ width:'100%', padding:'12px', background:'#1B6B5F', color:'white', border:'none', borderRadius:10, fontWeight:700, cursor:'pointer', fontSize:'0.85rem' }}>
              Download PDF Now
            </button>
            <p style={{ color:'rgba(255,255,255,0.3)', fontSize:'0.68rem', marginTop:'1rem', textAlign:'center', lineHeight:1.5 }}>
              This report is for educational purposes only and does not constitute medical advice or diagnosis.
            </p>
          </div>
        </div>
      )}
          ...
          <div style={{ background: '#fff', color: '#111', borderRadius: 24, maxWidth: 440, width: '100%', padding: '2rem', boxShadow: '0 32px 80px rgba(0,0,0,0.5)' }}>
            ...
            <ol style={{ paddingLeft: '1.25rem', margin: '0 0 1.5rem', display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                ...
                'Name the file something clear, e.g. "ParasitePro_Report.pdf".',
                'Bring the PDF to your GP appointment, or email it to your clinic ahead of your visit.',
                'Optional: add a note — "ParasitePro educational report – for discussion at our appointment".',
              ].map((step, i) => (
