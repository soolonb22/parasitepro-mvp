...
const NotificationSettingsPage = () => (
  <>
    <Helmet><title>Notifications | Parasite Identification Pro</title></Helmet>
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: 'var(--bg-base)' }}>
      <div className="text-center max-w-md">
        <div style={{ fontSize: '3.5rem', marginBottom: '1.25rem' }}>🔔</div>
        <h1 className="font-display font-bold text-2xl mb-3" style={{ color: 'var(--text-primary)' }}>Notifications</h1>
        <p className="text-sm mb-2" style={{ color: 'var(--text-muted)' }}>
          Control how and when you receive health updates, analysis reminders, and new feature announcements.
        </p>
