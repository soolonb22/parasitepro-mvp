...
import { Microscope, Mail, Lock, Loader2, AlertCircle, Eye, EyeOff } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50/30 to-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to your ParasitePro account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-100 p-8">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-9 pr-10 border-slate-200 focus:border-teal-400 focus:ring-teal-400"
                  required
                />
                <button
                  type="button"
          ...
          <p className="text-center text-sm text-slate-500 mt-5">
            ...
            <Link href={`/signup${next !== '/dashboard' ? `?next=${next}` : ''}`} className="text-teal-600 font-semibold hover:underline">
              Create one free
            </Link>
          </p>
        </div>
        ...
        <p className="text-center text-xs text-slate-400 mt-4">
          Educational tool only — not a medical service.{' '}
