    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      <div className="bg-white rounded-3xl shadow-xl p-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="relative bg-slate-100 rounded-3xl p-6 overflow-hidden">
            <img 
            ...
            {/* Animated green highlight circles */}
            <div className="absolute top-28 left-24 w-20 h-20 border-4 border-emerald-400 rounded-full 
                            animate-[ping_2s_ease-in-out_infinite]"></div>
            <div className="absolute top-40 right-32 w-16 h-16 border-4 border-emerald-400 rounded-full 
                            animate-[ping_2.3s_ease-in-out_infinite_300ms]"></div>
            <div className="absolute bottom-32 left-1/3 w-14 h-14 border-4 border-emerald-400 rounded-full 
                            animate-[ping_2.7s_ease-in-out_infinite_600ms]"></div>
            
            {/* Arrows */}
            <div className="absolute top-32 left-40 text-emerald-500 text-2xl animate-bounce">↓</div>
            <div className="absolute top-44 right-40 text-emerald-500 text-2xl animate-bounce delay-150">→</div>
          </div>
