        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                ...
                className="bg-teal-600 hover:bg-teal-700 text-white px-10 py-6 rounded-3xl text-lg font-medium flex items-center justify-center gap-3 transition-all active:scale-[0.98]"
              >
              ...
              <button 
                ...
                className="border-2 border-navy hover:bg-navy hover:text-white text-navy px-8 py-6 rounded-3xl text-lg font-medium flex items-center justify-center gap-3 transition-all"
              >
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-4 pt-8 text-sm text-slate-500">
              ...
              <div className="flex items-center gap-2">
                <span className="text-lg">🇦🇺</span> Built in Australia
              </div>
              <div className="flex items-center gap-2">
                <i className="fas fa-shield-alt text-teal-600"></i> Educational Tool Only
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative max-w-xs lg:max-w-md">
              ...
              <div className="absolute -bottom-6 left-6 bg-white px-6 py-4 rounded-3xl shadow-xl max-w-[220px]">
