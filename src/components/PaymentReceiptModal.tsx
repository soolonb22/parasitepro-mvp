...
For support: support@parasitepro.com
    `.trim();
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="bg-gray-700 rounded-xl p-4 space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-white font-semibold">{creditsAdded}</span>
            </div>
            <div className="flex justify-between text-sm border-t border-gray-600 pt-3">
              ...
              <div className="text-right">
                <div className="text-white font-semibold">USD ${amountUSD}</div>
                <div className="text-gray-500 text-xs">~AUD ${amountAUD}</div>
              </div>
            </div>
            <div className="flex justify-between text-sm border-t border-gray-600 pt-3">
              <span className="text-gray-400">New credit balance</span>
              <span className="text-green-400 font-bold">{newBalance} credits</span>
            </div>
          </div>
          <button onClick={handleDownloadReceipt} className="w-full flex items-center justify-center gap-2 py-2.5 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded-xl text-sm font-medium transition-colors">
            <Download size={16} />
            Download Receipt
          </button>
          <button onClick={() => { onClose(); navigate('/upload'); }} className="w-full flex items-center justify-center gap-2 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-colors">
            <Upload size={18} />
